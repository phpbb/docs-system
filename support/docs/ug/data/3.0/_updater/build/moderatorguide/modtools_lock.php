<?php
		// The page title
		$page_title = '4.2.1. Locking a topic or post';

$navigation = array(
	'home' => array('../index.php','phpBB 3.0 Olympus Documentation'),
	'this' => array('../moderatorguide/modtools_lock.php','Locking a topic or post'),
	'prev' => array('../',''),
	'next' => array('../',''),
...
ob_start();
?>
<div xmlns="http://www.w3.org/1999/xhtml" class="section" lang="en"><div class="titlepage"><div><div><h3 class="title"><span xmlns="" id="modtools_lock"/>4.2.1. Locking a topic or post</h3></div></div></div><p>This outlines how a moderator may lock whole topics or individual posts. There are various ways a moderator may do this, either by using the <a href="moderator_mcp.php" title="4.5. The Moderator Control Panel (MCP)">Moderator Control Panel</a> when viewing a forum, navigating to the selection menu beneath the topic in question, or editing any post within a topic and checking the relevant checkbox.</p><p>Locking a whole topic ensures that no user can reply to it, whereas locking individual posts denies the post author any editing permissions for that post.</p></div><div class="copyright">© 2006, 2008 phpBB Group — Licensed under the Creative Commons <a href="http://creativecommons.org/licenses/by-nc-sa/3.0/">Attribution-NonCommercial-ShareAlike 3.0</a> license</div>
<?php
