<?php
		// The page title
		$page_title = '4.2.8. Merge posts into another topic';

$navigation = array(
	'home' => array('../index.php','phpBB 3.0 Olympus Documentation'),
	'this' => array('../moderatorguide/modtools_mergeposts.php','Merge posts into another topic'),
	'prev' => array('../',''),
	'next' => array('../',''),
...
ob_start();
?>
<div xmlns="http://www.w3.org/1999/xhtml" class="section" lang="en"><div class="titlepage"><div><div><h3 class="title"><span xmlns="" id="modtools_mergeposts"/>4.2.8. Merge posts into another topic</h3></div><div><div class="authorgroup"><div class="author"><h3 class="author"><span class="othername">camm15h</span></h3></div><div class="author"><h3 class="author"><span class="othername">MennoniteHobbit</span></h3></div></div></div></div></div><p>Rather than just merging topics together, you can also merge specific posts into any other topic.</p><p>To merge specific posts into another topic, start by locating the selection menu beneath the topic, and get to the <a href="moderator_mcp.php" title="4.5. The Moderator Control Panel (MCP)">Moderator Control Panel</a>. From here, you need to enter the topic ID of the topic you want to move the posts to. You can click <span class="guilabel">Select topic</span> to see a list of the topics available and specify which. Select the posts which you wish to merge from the current topic, into the existing topic. The posts merged into the new topic will retain their existing timestamp (e.g. they will not appear at the end of the topic they are being merged to, but will be sorted based on their timestamp).</p></div><div class="copyright">© 2006, 2008 phpBB Group — Licensed under the Creative Commons <a href="http://creativecommons.org/licenses/by-nc-sa/3.0/">Attribution-NonCommercial-ShareAlike 3.0</a> license</div>
<?php
