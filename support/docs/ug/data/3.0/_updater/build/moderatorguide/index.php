<?php
		// The page title
		$page_title = 'Chapter 4. Moderator Guide';

$navigation = array(
	'home' => array('../index.php','phpBB 3.0 Olympus Documentation'),
	'this' => array('../moderatorguide/index.php','Moderator Guide'),
	'prev' => array('../',''),
	'next' => array('../',''),
...
ob_start();
?>
<div xmlns="http://www.w3.org/1999/xhtml" class="chapter" lang="en"><div class="titlepage"><div><div><h2 class="title"><span xmlns="" id="moderator_guide"/>Chapter 4. Moderator Guide</h2></div><div><p class="releaseinfo">$Id: moderator_guide.xml 365 2010-07-03 23:01:02Z Noxwizard $</p></div><div><p class="copyright">Copyright © 2006 phpBB Group</p></div></div></div><div class="toc"><p><b>Table of Contents</b></p><dl><dt><span class="section"><a href="moderator_edit.php">4.1. Editing posts</a></span></dt><dt><span class="section"><a href="moderator_modtools.php">4.2. Moderation tools</a></span></dt><dd><dl><dt><span class="section"><a href="modtools_lock.php">4.2.1. Locking a topic or post</a></span></dt><dt><span class="section"><a href="modtools_delete.php">4.2.2. Deleting a topic or post</a></span></dt><dt><span class="section"><a href="modtools_move.php">4.2.3. Moving a topic into another forum</a></span></dt><dd><dl><dt><span class="section"><a href="modtools_move.php#modtools_move_shadow">4.2.3.1. Shadow Topics</a></span></dt></dl></dd><dt><span class="section"><a href="modtools_copy.php">4.2.4. Duplicating a topic</a></span></dt><dt><span class="section"><a href="modtools_type.php">4.2.5. Announcements and stickies</a></span></dt><dt><span class="section"><a href="modtools_split.php">4.2.6. Splitting posts off a topic</a></span></dt><dt><span class="section"><a href="modtools_mergetopics.php">4.2.7. Merge topics</a></span></dt><dt><span class="section"><a href="modtools_mergeposts.php">4.2.8. Merge posts into another topic</a></span></dt></dl></dd><dt><span class="section"><a href="moderator_queue.php">4.3. What is the “Moderation queue”?</a></span></dt><dt><span class="section"><a href="moderator_reported.php">4.4. What are “Reported posts”?</a></span></dt><dt><span class="section"><a href="moderator_mcp.php">4.5. The Moderator Control Panel (MCP)</a></span></dt><dd><dl><dt><span class="section"><a href="mcp_queue.php">4.5.1. Moderation queue</a></span></dt><dt><span class="section"><a href="mcp_reported.php">4.5.2. Reported posts</a></span></dt><dt><span class="section"><a href="mcp_forum.php">4.5.3. Forum moderation</a></span></dt></dl></dd></dl></div><div class="abstract"><p class="title"><b>Abstract</b></p><p>This chapter describes the phpBB 3.0 forum moderation controls.</p></div></div><div class="copyright">© 2006, 2008 phpBB Group — Licensed under the Creative Commons <a href="http://creativecommons.org/licenses/by-nc-sa/3.0/">Attribution-NonCommercial-ShareAlike 3.0</a> license</div>
<?php
