<?php
		// The page title
		$page_title = '4.2.4. Duplicating a topic';

$navigation = array(
	'home' => array('../index.php','phpBB 3.0 Olympus Documentation'),
	'this' => array('../moderatorguide/modtools_copy.php','Duplicating a topic'),
	'prev' => array('../',''),
	'next' => array('../',''),
...
ob_start();
?>
<div xmlns="http://www.w3.org/1999/xhtml" class="section" lang="en"><div class="titlepage"><div><div><h3 class="title"><span xmlns="" id="modtools_copy"/>4.2.4. Duplicating a topic</h3></div><div><div class="authorgroup"><div class="author"><h3 class="author"><span class="othername">camm15h</span></h3></div><div class="author"><h3 class="author"><span class="othername">MennoniteHobbit</span></h3></div></div></div></div></div><p>Moderators are also allowed to duplicate topics. Duplicating a topic simply creates a copy of the selected topic in another forum. This can be achieved by using the <span class="guilabel">Quick MOD Tools</span> area beneath the topic you want to duplicate, or through the <a href="moderator_mcp.php" title="4.5. The Moderator Control Panel (MCP)">Moderator Control Panel</a>  when viewing the forum. From this, you simply select the destination forum you wish to duplicate the topic to. Click <span class="guilabel">Yes</span> to duplicate the topic.</p></div><div class="copyright">© 2006, 2008 phpBB Group — Licensed under the Creative Commons <a href="http://creativecommons.org/licenses/by-nc-sa/3.0/">Attribution-NonCommercial-ShareAlike 3.0</a> license</div>
<?php
