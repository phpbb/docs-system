<?php
		// The page title
		$page_title = '4.2. Moderation tools';

$navigation = array(
	'home' => array('../index.php','phpBB 3.0 Olympus Documentation'),
	'this' => array('../moderatorguide/moderator_modtools.php','Moderation tools'),
	'prev' => array('../',''),
	'next' => array('../',''),
...
ob_start();
?>
<div xmlns="http://www.w3.org/1999/xhtml" class="section" lang="en"><div class="titlepage"><div><div><h2 class="title" style="clear: both"><span xmlns="" id="moderator_modtools"/>4.2. Moderation tools</h2></div><div><div class="authorgroup"><div class="author"><h3 class="author"><span class="othername">camm15h</span></h3></div><div class="author"><h3 class="author"><span class="othername">MennoniteHobbit</span></h3></div></div></div></div></div><p>Beneath topics, the moderator has various options in a dropdown box which modify the topic in different ways. These include the ability to lock, unlock, delete, move, split, merge and copy the topic. As well as these, they are also able to change the topic type (Sticky/Announcement/Global), and also view the topics logs. The following subsections detail each action on a topic that a moderator can perform.</p><div class="figure"><span xmlns="" id="quick_mod_tools"/><p class="title"><b>Figure 4.1. Quick Mod Tools</b></p><div class="mediaobject"><img src="../images/moderator_guide/quick_mod_tools.png" alt="Quick Mod Tools"/><div class="caption"><p>The quick moderator tools. As you can see, these tools are located at the end of each topic at the bottom of the page, before the last post on that page. Clicking on the selection menu will show you all of the actions you may perform.</p></div></div></div></div><div class="copyright">© 2006, 2008 phpBB Group — Licensed under the Creative Commons <a href="http://creativecommons.org/licenses/by-nc-sa/3.0/">Attribution-NonCommercial-ShareAlike 3.0</a> license</div>
<?php
