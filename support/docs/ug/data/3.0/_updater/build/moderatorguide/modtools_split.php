<?php
		// The page title
		$page_title = '4.2.6. Splitting posts off a topic';

$navigation = array(
	'home' => array('../index.php','phpBB 3.0 Olympus Documentation'),
	'this' => array('../moderatorguide/modtools_split.php','Splitting posts off a topic'),
	'prev' => array('../',''),
	'next' => array('../',''),
...
ob_start();
?>
<div xmlns="http://www.w3.org/1999/xhtml" class="section" lang="en"><div class="titlepage"><div><div><h3 class="title"><span xmlns="" id="modtools_split"/>4.2.6. Splitting posts off a topic</h3></div><div><div class="authorgroup"><div class="author"><h3 class="author"><span class="othername">camm15h</span></h3></div><div class="author"><h3 class="author"><span class="othername">MennoniteHobbit</span></h3></div></div></div></div></div><p>Moderators also have the ability to split posts from a topic. This can be useful if certain discussions have spawned a new idea worthy of its own thread, thus needing to be split from the original topic. Splitting posts involves moving individual posts from an existing topic to a new topic. You may do this by using the <span class="guilabel">Quick MOD Tools</span> area beneath the topic you want to split or from the <a href="moderator_mcp.php" title="4.5. The Moderator Control Panel (MCP)">Moderator Control Panel</a> within the topic.</p><p>While splitting, you may choose a title for the new topic, a different forum for the new topic, and also a different icon. You may also override the default board settings for the amount of posts to be displayed per page. The <span class="guilabel">Splitting from the selected post</span> option will split all posts from the checked post, to the last post. The <span class="guilabel">Splitting selected posts</span> option will only split the current selected posts. </p></div><div class="copyright">© 2006, 2008 phpBB Group — Licensed under the Creative Commons <a href="http://creativecommons.org/licenses/by-nc-sa/3.0/">Attribution-NonCommercial-ShareAlike 3.0</a> license</div>
<?php
