<?php
		// The page title
		$page_title = '2.2.2. Preliminary steps';

$navigation = array(
	'home' => array('../index.php','phpBB 3.0 Olympus Documentation'),
	'this' => array('../upgradeguide/upgrade_general_preliminary.php','Preliminary steps'),
	'prev' => array('../',''),
	'next' => array('../',''),
...
ob_start();
?>
<div xmlns="http://www.w3.org/1999/xhtml" class="section" lang="en"><div class="titlepage"><div><div><h3 class="title"><span xmlns="" id="upgrade_general_preliminary"/>2.2.2. Preliminary steps</h3></div><div><div class="authorgroup"><div class="author"><h3 class="author"><span class="othername">Dicky</span></h3></div><div class="author"><h3 class="author"><span class="othername">ameeck</span></h3></div></div></div></div></div><p>phpBB3 needs to be installed. Once phpBB3 is installed, do <span class="emphasis"><em>not</em></span> delete the <code class="filename">install</code> directory if you will be converting immediately. If you will be testing and setting up your phpBB3 board prior to the conversion and converting at a later time, rename the <code class="filename">install</code> directory to something like _install. This will allow you to use your phpBB3 board. You will be needing the install directory later for the conversion.</p><p>You will need specific convertor files for the board software you are converting from. The phpBB2 specific convertor files are included with the phpBB3 installation files. For other board softwares, you will need to get the convertor files from the appropriate phpBB3 convertor topic. These topics can be found in the <a href="http://www.phpbb.com/community/viewforum.php?f=65" target="_top">[3.0.x] Convertors forum</a> on phpBB.com</p><p>For converting from phpBB2, you only need to point your browser to {phpBB3_root_directory}/install/index.php, click the <span class="guilabel">Convert</span> tab and follow the instructions. For other board softwares, you will need to upload the convertor files to the appropriate directories. The convertor files you get will consist of two or three files, convert_xxx.php, functions_xxx.php and, optionally, auth_xxx.php. The xxx will generally be the name of the software you are converting from.</p></div><div class="copyright">© 2006, 2008 phpBB Group — Licensed under the Creative Commons <a href="http://creativecommons.org/licenses/by-nc-sa/3.0/">Attribution-NonCommercial-ShareAlike 3.0</a> license</div>
<?php
