<?php
		// The page title
		$page_title = '2.2.1. Requirements';

$navigation = array(
	'home' => array('../index.php','phpBB 3.0 Olympus Documentation'),
	'this' => array('../upgradeguide/upgrade_general_requirements.php','Requirements'),
	'prev' => array('../',''),
	'next' => array('../',''),
...
ob_start();
?>
<div xmlns="http://www.w3.org/1999/xhtml" class="section" lang="en"><div class="titlepage"><div><div><h3 class="title"><span xmlns="" id="upgrade_general_requirements"/>2.2.1. Requirements</h3></div><div><div class="authorgroup"><div class="author"><h3 class="author"><span class="othername">Dicky</span></h3></div><div class="author"><h3 class="author"><span class="othername">ameeck</span></h3></div></div></div></div></div><p>In order for the the conversion to be smooth as possible, check and prepare these items. You will need them to perform a succesful conversion.</p><div class="itemizedlist"><ul type="disc"><li><p>An installation of phpBB3 has to be present on your server. See <a href="../quickstart/quick_requirements.php" title="1.1. Requirements">Section 1.1, “Requirements”</a> for more information on how to install phpBB3.</p></li><li><p>Prepare the connection details to the database where the old board was stored. If you are unsure, you can find these details in the config file.</p></li><li><p>Make sure the old forum is still installed on your server alongside the phpBB3 installations. The files of the old board should be kept as is, some of them will be transferred to phpBB3 (e.g. avatars, attachments, smilies or ranks).</p></li><li><p>The files and database need to be on the same server as the phpBB3 installation and the files need to be in the same domain. If you are using subdomains, the files need to be in the same subdomain.</p></li></ul></div></div><div class="copyright">© 2006, 2008 phpBB Group — Licensed under the Creative Commons <a href="http://creativecommons.org/licenses/by-nc-sa/3.0/">Attribution-NonCommercial-ShareAlike 3.0</a> license</div>
<?php
