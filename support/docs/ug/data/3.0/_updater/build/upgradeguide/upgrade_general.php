<?php
		// The page title
		$page_title = '2.2. Upgrading from any board software to phpBB3';

$navigation = array(
	'home' => array('../index.php','phpBB 3.0 Olympus Documentation'),
	'this' => array('../upgradeguide/upgrade_general.php','Upgrading from any board software to phpBB3'),
	'prev' => array('../',''),
	'next' => array('../',''),
...
ob_start();
?>
<div xmlns="http://www.w3.org/1999/xhtml" class="section" lang="en"><div class="titlepage"><div><div><h2 class="title" style="clear: both"><span xmlns="" id="upgrade_general"/>2.2. Upgrading from any board software to phpBB3</h2></div><div><div class="authorgroup"><div class="author"><h3 class="author"><span class="othername">Dicky</span></h3></div><div class="author"><h3 class="author"><span class="othername">ameeck</span></h3></div></div></div></div></div><p>In order to allow administrators of phpBB2 boards to use phpBB3 and all of its features. There is a convertor packed with the default installation. The conversion framework is flexible and allows you to convert other bulletin board systems as well. Read more if you need help with converting your board to phpBB3</p><div class="note" style="margin-left: 0.5in; margin-right: 0.5in;"><h3 class="title">Note</h3><p>The convertor will not harm the database of the board software you are converting from. In case of a problem, your old board software will still be fully operational.</p></div></div><div class="copyright">© 2006, 2008 phpBB Group — Licensed under the Creative Commons <a href="http://creativecommons.org/licenses/by-nc-sa/3.0/">Attribution-NonCommercial-ShareAlike 3.0</a> license</div>
<?php
