<?php
		// The page title
		$page_title = 'Chapter 2. Upgrade Guide';

$navigation = array(
	'home' => array('../index.php','phpBB 3.0 Olympus Documentation'),
	'this' => array('../upgradeguide/index.php','Upgrade Guide'),
	'prev' => array('../',''),
	'next' => array('../',''),
...
ob_start();
?>
<div xmlns="http://www.w3.org/1999/xhtml" class="chapter" lang="en"><div class="titlepage"><div><div><h2 class="title"><span xmlns="" id="upgrade_guide"/>Chapter 2. Upgrade Guide</h2></div><div><p class="releaseinfo">$Id: upgrade_guide.xml 350 2010-01-10 03:02:33Z Marshalrusty $</p></div><div><p class="copyright">Copyright © 2009 phpBB Group</p></div></div></div><div class="toc"><p><b>Table of Contents</b></p><dl><dt><span class="section"><a href="upgrade.php">2.1. Upgrading from 2.0 to 3.0</a></span></dt><dt><span class="section"><a href="upgrade_general.php">2.2. Upgrading from any board software to phpBB3</a></span></dt><dd><dl><dt><span class="section"><a href="upgrade_general_requirements.php">2.2.1. Requirements</a></span></dt><dt><span class="section"><a href="upgrade_general_preliminary.php">2.2.2. Preliminary steps</a></span></dt><dt><span class="section"><a href="upgrade_general_conversion.php">2.2.3. Conversion steps</a></span></dt></dl></dd></dl></div><div class="abstract"><p class="title"><b>Abstract</b></p><p>Do you want to upgrade your phpBB2 forum to version 3.0? This chapter will tell and show you how it is done.</p></div></div><div class="copyright">© 2006, 2008 phpBB Group — Licensed under the Creative Commons <a href="http://creativecommons.org/licenses/by-nc-sa/3.0/">Attribution-NonCommercial-ShareAlike 3.0</a> license</div>
<?php
