<?php
		// The page title
		$page_title = '2.1. Upgrading from 2.0 to 3.0';

$navigation = array(
	'home' => array('../index.php','phpBB 3.0 Olympus Documentation'),
	'this' => array('../upgradeguide/upgrade.php','Upgrading from 2.0 to 3.0'),
	'prev' => array('../',''),
	'next' => array('../',''),
	'up'   => array('../upgradeguide/index.php','Upgrade Guide'),
...
ob_start();
?>
<div xmlns="http://www.w3.org/1999/xhtml" class="section" lang="en"><div class="titlepage"><div><div><h2 class="title" style="clear: both"><span xmlns="" id="upgrade"/>2.1. Upgrading from 2.0 to 3.0</h2></div><div><div class="authorgroup"><div class="author"><h3 class="author"><span class="othername">Techie-Micheal</span></h3></div></div></div></div></div><p>In order to allow administrators of phpBB2 boards to use phpBB3 and all of its features. There is a convertor packed with the default installation. The conversion framework is flexible and allows you to convert other bulletin board systems as well. Read more if you need help with converting your board to phpBB3</p><p>The process is in the form of a PHP file, similar to the update file found in phpBB 2.0.x. The file will take you through wizard-like screens until your phpBB is running 3.0.x. Basic instructions and troubleshooting for doing this conversion are <a href="http://www.phpbb.com/community/docs/INSTALL.html#convert" target="_top">here</a>.</p><p>Warning: Be sure to backup both the database and the files before attempting to upgrade.</p></div><div class="copyright">© 2006, 2008 phpBB Group — Licensed under the Creative Commons <a href="http://creativecommons.org/licenses/by-nc-sa/3.0/">Attribution-NonCommercial-ShareAlike 3.0</a> license</div>
<?php
