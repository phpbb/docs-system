<?php
		// The page title
		$page_title = 'Chapter 6. Glossary';

$navigation = array(
	'home' => array('../index.php','phpBB 3.0 Olympus Documentation'),
	'this' => array('../glossary/index.php','Glossary'),
	'prev' => array('../',''),
	'next' => array('../',''),
...
ob_start();
?>
<div xmlns="http://www.w3.org/1999/xhtml" class="chapter" lang="en"><div class="titlepage"><div><div><h2 class="title"><span xmlns="" id="glossary"/>Chapter 6. Glossary</h2></div><div><p class="releaseinfo">$Id: glossary.xml 350 2010-01-10 03:02:33Z Marshalrusty $</p></div><div><p class="copyright">Copyright © 2006 phpBB Group</p></div></div></div><div class="toc"><p><b>Table of Contents</b></p><dl><dt><span class="section"><a href="terms.php">6.1. Terms</a></span></dt></dl></div><div class="abstract"><p class="title"><b>Abstract</b></p><p>A guide to the terms used in the phpBB Documentation and on the forums.</p></div></div><div class="copyright">© 2006, 2008 phpBB Group — Licensed under the Creative Commons <a href="http://creativecommons.org/licenses/by-nc-sa/3.0/">Attribution-NonCommercial-ShareAlike 3.0</a> license</div>
<?php
