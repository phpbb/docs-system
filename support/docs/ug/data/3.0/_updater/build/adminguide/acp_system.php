<?php
		// The page title
		$page_title = '3.10. System Configuration';

$navigation = array(
	'home' => array('../index.php','phpBB 3.0 Olympus Documentation'),
	'this' => array('../adminguide/acp_system.php','System Configuration'),
	'prev' => array('../',''),
	'next' => array('../',''),
...
ob_start();
?>
<div xmlns="http://www.w3.org/1999/xhtml" class="section" lang="en"><div class="titlepage"><div><div><h2 class="title" style="clear: both"><span xmlns="" id="acp_system"/>3.10. System Configuration</h2></div><div><div class="authorgroup"><div class="author"><h3 class="author"><span class="othername">ameeck</span></h3></div><div class="author"><h3 class="author"><span class="othername">Graham</span></h3></div></div></div></div></div><p>Controls which affect the whole board and which are a key part of configuring and running phpBB are located in the System section. Most of these settings require more attention from the administrator and are not so easy to configure, fortunately you will probably not be changing them too often. This includes keeping your installation up-to-date, managing the board's languages or editing the structure of phpBB's control panels.</p></div><div class="copyright">© 2006, 2008 phpBB Group — Licensed under the Creative Commons <a href="http://creativecommons.org/licenses/by-nc-sa/3.0/">Attribution-NonCommercial-ShareAlike 3.0</a> license</div>
<?php
