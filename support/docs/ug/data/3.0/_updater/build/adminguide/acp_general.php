<?php
		// The page title
		$page_title = '3.2. General Configuration and Front Page';

$navigation = array(
	'home' => array('../index.php','phpBB 3.0 Olympus Documentation'),
	'this' => array('../adminguide/acp_general.php','General Configuration and Front Page'),
	'prev' => array('../',''),
	'next' => array('../',''),
...
ob_start();
?>
<div xmlns="http://www.w3.org/1999/xhtml" class="section" lang="en"><div class="titlepage"><div><div><h2 class="title" style="clear: both"><span xmlns="" id="acp_general"/>3.2. General Configuration and Front Page</h2></div><div><div class="authorgroup"><div class="author"><h3 class="author"><span class="othername">dhn</span></h3></div></div></div></div></div><p>The <span class="guimenuitem">General</span> section is the first screen you see each time you log into the <span class="acronym">ACP</span>. It contains some basic statistics and information about your forum. It also has a subsection called <span class="guimenuitem">Quick Access</span>. It provides quick access to some of the admin pages that are frequently used, like <a href="acp_users.php" title="3.5. Users Management">User Management</a> or <a href="acp_maintenance.php" title="3.9. Board Maintenance">Moderator Logs</a>. We will discuss its items later in their specific sections.</p><p>We will concentrate on the other three subsections: <a href="acp_general_config.php" title="3.2.1. Board Configuration">Board Configuration</a>, <a href="acp_general_client.php" title="3.2.2. Client communication">Client Communication</a>, and <a href="acp_general_server.php" title="3.2.3. Server configuration">Server Configuration</a>.</p></div><div class="copyright">© 2006, 2008 phpBB Group — Licensed under the Creative Commons <a href="http://creativecommons.org/licenses/by-nc-sa/3.0/">Attribution-NonCommercial-ShareAlike 3.0</a> license</div>
<?php
