<?php
		// The page title
		$page_title = '3.3.1. Explanation of forum types';

$navigation = array(
	'home' => array('../index.php','phpBB 3.0 Olympus Documentation'),
	'this' => array('../adminguide/acp_forums_types.php','Explanation of forum types'),
	'prev' => array('../',''),
	'next' => array('../',''),
	'up'   => array('../adminguide/acp_forums.php','Forum Admin'),
...
ob_start();
?>
<div xmlns="http://www.w3.org/1999/xhtml" class="section" lang="en"><div class="titlepage"><div><div><h3 class="title"><span xmlns="" id="acp_forums_types"/>3.3.1. Explanation of forum types</h3></div><div><div class="authorgroup"><div class="author"><h3 class="author"><span class="othername">dhn</span></h3></div></div></div></div></div><p>In phpBB 3.0, there are three forum types. A forum can be a normal forum where people can post in, a category that contains forums, or it can be a simple link.</p><div class="variablelist"><dl><dt><span class="term">Forum</span></dt><dd><p>In a forum people can post their topics.</p></dd><dt><span class="term">Link</span></dt><dd><p>The forum list displays a forum link like a normal forum. But instead of linking to a forum, you can point it to a URL of your choice. It can display a hit counter, which shows how many times the link was clicked.</p></dd><dt><span class="term">Category</span></dt><dd><p>If you want to combine multiple forums or links for a specific topic, you can put them inside a category. The forums will appear below the category title, clearly separated from other categories. Users are not able to post inside categories.</p></dd></dl></div></div><div class="copyright">© 2006, 2008 phpBB Group — Licensed under the Creative Commons <a href="http://creativecommons.org/licenses/by-nc-sa/3.0/">Attribution-NonCommercial-ShareAlike 3.0</a> license</div>
<?php
