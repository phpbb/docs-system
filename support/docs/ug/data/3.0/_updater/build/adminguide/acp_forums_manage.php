<?php
		// The page title
		$page_title = '3.3.3. Manage forums';

$navigation = array(
	'home' => array('../index.php','phpBB 3.0 Olympus Documentation'),
	'this' => array('../adminguide/acp_forums_manage.php','Manage forums'),
	'prev' => array('../',''),
	'next' => array('../',''),
...
ob_start();
?>
<div xmlns="http://www.w3.org/1999/xhtml" class="section" lang="en"><div class="titlepage"><div><div><h3 class="title"><span xmlns="" id="acp_forums_manage"/>3.3.3. Manage forums</h3></div><div><div class="authorgroup"><div class="author"><h3 class="author"><span class="othername">dhn</span></h3></div></div></div></div></div><p>Here you can add, edit, delete, and reorder the forums, categories, and links.</p><div class="figure"><span xmlns="" id="img_acp_forums_manage_legend"/><p class="title"><b>Figure 3.4. Managing Forums Icon Legend</b></p><div class="mediaobject"><img src="../images/admin_guide/manage_forums_icon_legend.png" alt="Managing Forums Icon Legend"/><div class="caption"><p>This is the legend for the icons on the manage forums page. Each icon allows you to commit a certain action. Pay close attention to which action you click on when managing your forums.</p></div></div></div><p>The initial <span class="guilabel">Manage forums</span> page shows you a list of your top level forums and categories. Note, that this is not analogue to the forum index, as categories are not expanded here. If you want to reorder the forums inside a category, you have to open the category first.</p></div><div class="copyright">© 2006, 2008 phpBB Group — Licensed under the Creative Commons <a href="http://creativecommons.org/licenses/by-nc-sa/3.0/">Attribution-NonCommercial-ShareAlike 3.0</a> license</div>
<?php
