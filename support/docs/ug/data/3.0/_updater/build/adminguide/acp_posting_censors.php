<?php
		// The page title
		$page_title = '3.4.5. Word censoring';

$navigation = array(
	'home' => array('../index.php','phpBB 3.0 Olympus Documentation'),
	'this' => array('../adminguide/acp_posting_censors.php','Word censoring'),
	'prev' => array('../',''),
	'next' => array('../',''),
...
ob_start();
?>
<div xmlns="http://www.w3.org/1999/xhtml" class="section" lang="en"><div class="titlepage"><div><div><h3 class="title"><span xmlns="" id="acp_posting_censors"/>3.4.5. Word censoring</h3></div><div><div class="authorgroup"><div class="author"><h3 class="author"><span class="othername">MennoniteHobbit</span></h3></div></div></div></div></div><p>On some forums, a certain level of appropriate, profanity-free speech is required. Like phpBB2, phpBB3 continues to offer word censoring. Words that match the patterns set in the <span class="guilabel">Word censoring</span> panel will automatically be censored with text that you, the admin, specify. To manage your board's word censoring, click <span class="guimenuitem">Word censoring</span>.</p><p>To add a new word censor, click <span class="guilabel">Add new word</span>. There are two fields: <span class="guilabel">Word</span> and <span class="guilabel">Replacement</span>. Type in the word that you want automatically censored in the <span class="guilabel">Word</span> text field. (Note that you can use wildcards (*).) Then, type in the text you want the censored word to be replaced with in the <span class="guilabel">Replacement</span> text field. Once you are done, click <span class="guilabel">Submit</span> to add the new censored word to your board.</p><p>To edit an existing word censor, locate the censored word's row. Click the "edit" icon located in that row, and proceed with changing the censored word's settings.</p></div><div class="copyright">© 2006, 2008 phpBB Group — Licensed under the Creative Commons <a href="http://creativecommons.org/licenses/by-nc-sa/3.0/">Attribution-NonCommercial-ShareAlike 3.0</a> license</div>
<?php
