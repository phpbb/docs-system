<?php
		// The page title
		$page_title = '3.9. Board Maintenance';

$navigation = array(
	'home' => array('../index.php','phpBB 3.0 Olympus Documentation'),
	'this' => array('../adminguide/acp_maintenance.php','Board Maintenance'),
	'prev' => array('../',''),
	'next' => array('../',''),
...
ob_start();
?>
<div xmlns="http://www.w3.org/1999/xhtml" class="section" lang="en"><div class="titlepage"><div><div><h2 class="title" style="clear: both"><span xmlns="" id="acp_maintenance"/>3.9. Board Maintenance</h2></div><div><div class="authorgroup"><div class="author"><h3 class="author"><span class="othername">dhn</span></h3></div><div class="author"><h3 class="author"><span class="othername">MennoniteHobbit</span></h3></div><div class="author"><h3 class="author"><span class="othername">ameeck</span></h3></div></div></div></div></div><p>Running a phpBB 3.0 board is a very important job that is up to the administrator(s). Maintaining the board to make sure it runs as cleanly and properly as possible is the administrator's job.</p><p><span class="guimenuitem">Board Maintenance</span> is a section in the <span class="acronym">ACP</span> that allows you to keep track of internal phpBB information, such as logs, as well as maintaining your database (which holds your phpBB-related data), such as backing up and restoring data.</p></div><div class="copyright">© 2006, 2008 phpBB Group — Licensed under the Creative Commons <a href="http://creativecommons.org/licenses/by-nc-sa/3.0/">Attribution-NonCommercial-ShareAlike 3.0</a> license</div>
<?php
