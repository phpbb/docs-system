<?php
		// The page title
		$page_title = '3.4. Posting Settings';

$navigation = array(
	'home' => array('../index.php','phpBB 3.0 Olympus Documentation'),
	'this' => array('../adminguide/acp_posting.php','Posting Settings'),
	'prev' => array('../',''),
	'next' => array('../',''),
...
ob_start();
?>
<div xmlns="http://www.w3.org/1999/xhtml" class="section" lang="en"><div class="titlepage"><div><div><h2 class="title" style="clear: both"><span xmlns="" id="acp_posting"/>3.4. Posting Settings</h2></div><div><div class="authorgroup"><div class="author"><h3 class="author"><span class="othername">dhn</span></h3></div><div class="author"><h3 class="author"><span class="othername">MennoniteHobbit</span></h3></div></div></div></div></div><p>Forums are nothing without content. Content is created and posted by your users; as such, it is very important to have the right posting settings that control how the content is posted. You can reach this section by clicking the <span class="guimenuitem">Posting</span> navigation tab.</p><p>The first page you are greeted with after getting to the <span class="guimenuitem">Posting Settings</span> section is <span class="guilabel">BBCodes</span>. The other available subsections are divided into two main groups: <span class="guilabel">Messages</span> and <span class="guilabel">Attachments</span>. <span class="guimenuitem">Private message settings</span>, <span class="guimenuitem">Topic icons</span>, <span class="guimenuitem">Smilies</span>, and <span class="guimenuitem">Word censoring</span> are message-related settings. <span class="guimenuitem">Attachment settings</span>, <span class="guimenuitem">Manage extensions</span>, <span class="guimenuitem">Manage extension groups</span>, and <span class="guimenuitem">Orphaned attachments</span> are attachment-related settings.</p></div><div class="copyright">© 2006, 2008 phpBB Group — Licensed under the Creative Commons <a href="http://creativecommons.org/licenses/by-nc-sa/3.0/">Attribution-NonCommercial-ShareAlike 3.0</a> license</div>
<?php
