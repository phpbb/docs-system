<?php
		// The page title
		$page_title = '3.7.2. Forum Based Permissions';

$navigation = array(
	'home' => array('../index.php','phpBB 3.0 Olympus Documentation'),
	'this' => array('../adminguide/acp_permissions_forumbased.php','Forum Based Permissions'),
	'prev' => array('../',''),
	'next' => array('../',''),
