<?php
		// The page title
		$page_title = '5.3. Orienting Yourself in the User Control Panel';

$navigation = array(
	'home' => array('../index.php','phpBB 3.0 Olympus Documentation'),
	'this' => array('../userguide/user_control_panel.php','Orienting Yourself in the User Control Panel'),
	'prev' => array('../',''),
	'next' => array('../',''),
