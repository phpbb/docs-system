<?php
		// The page title
		$page_title = 'Chapter 5. User Guide';

$navigation = array(
	'home' => array('../index.php','phpBB 3.0 Olympus Documentation'),
	'this' => array('../userguide/index.php','User Guide'),
	'prev' => array('../',''),
	'next' => array('../',''),
...
ob_start();
?>
<div xmlns="http://www.w3.org/1999/xhtml" class="chapter" lang="en"><div class="titlepage"><div><div><h2 class="title"><span xmlns="" id="user_guide"/>Chapter 5. User Guide</h2></div><div><p class="releaseinfo">$Id: user_guide.xml 365 2010-07-03 23:01:02Z Noxwizard $</p></div><div><p class="copyright">Copyright © 2006 phpBB Group</p></div></div></div><div class="toc"><p><b>Table of Contents</b></p><dl><dt><span class="section"><a href="user_permissions.php">5.1. How user permissions affect forum experience</a></span></dt><dt><span class="section"><a href="user_registering.php">5.2. Registering on a phpBB3 board</a></span></dt><dt><span class="section"><a href="user_control_panel.php">5.3. Orienting Yourself in the User Control Panel</a></span></dt><dd><dl><dt><span class="section"><a href="ucp_overview.php">5.3.1. Overview</a></span></dt><dd><dl><dt><span class="section"><a href="ucp_overview.php#ucp_subscriptions">5.3.1.1. Subscriptions</a></span></dt><dt><span class="section"><a href="ucp_overview.php#ucp_bookmarks">5.3.1.2. Bookmarks</a></span></dt><dt><span class="section"><a href="ucp_overview.php#ucp_drafts">5.3.1.3. Drafts</a></span></dt></dl></dd><dt><span class="section"><a href="ucp_profile.php">5.3.2. Profile</a></span></dt><dd><dl><dt><span class="section"><a href="ucp_profile.php#ucp_profile_info">5.3.2.1. Personal settings</a></span></dt><dt><span class="section"><a href="ucp_profile.php#ucp_signature">5.3.2.2. Signature</a></span></dt><dt><span class="section"><a href="ucp_profile.php#ucp_avatar">5.3.2.3. Avatar</a></span></dt></dl></dd><dt><span class="section"><a href="ucp_preferences.php">5.3.3. Preferences</a></span></dt><dd><dl><dt><span class="section"><a href="ucp_preferences.php#ucp_global">5.3.3.1. Global</a></span></dt><dt><span class="section"><a href="ucp_preferences.php#ucp_posting">5.3.3.2. Posting</a></span></dt><dt><span class="section"><a href="ucp_preferences.php#ucp_display">5.3.3.3. Display</a></span></dt></dl></dd><dt><span class="section"><a href="ucp_friends_foes.php">5.3.4. Friends and Foes</a></span></dt><dt><span class="section"><a href="ucp_attachments.php">5.3.5. Attachments</a></span></dt><dt><span class="section"><a href="ucp_usergroups.php">5.3.6. Usergroups</a></span></dt></dl></dd><dt><span class="section"><a href="user_posting.php">5.4. Mastering the Posting Screen</a></span></dt><dd><dl><dt><span class="section"><a href="posting_form.php">5.4.1. Posting Form</a></span></dt><dt><span class="section"><a href="posting_smilies.php">5.4.2. Smilies</a></span></dt><dt><span class="section"><a href="posting_bbcodes.php">5.4.3. BBCodes</a></span></dt><dt><span class="section"><a href="posting_options.php">5.4.4. Post Options</a></span></dt><dd><dl><dt><span class="section"><a href="posting_options.php#posting_special">5.4.4.1. Topic Types</a></span></dt></dl></dd><dt><span class="section"><a href="posting_attachments.php">5.4.5. Attachments</a></span></dt><dt><span class="section"><a href="posting_polls.php">5.4.6. Polls</a></span></dt><dt><span class="section"><a href="posting_drafts.php">5.4.7. Drafts</a></span></dt></dl></dd><dt><span class="section"><a href="user_pm.php">5.5. Communicate with Private Messages</a></span></dt><dd><dl><dt><span class="section"><a href="pm_display.php">5.5.1. Message display</a></span></dt><dt><span class="section"><a href="pm_new.php">5.5.2. Composing a new message</a></span></dt><dt><span class="section"><a href="pm_folders.php">5.5.3. Message Folders</a></span></dt><dd><dl><dt><span class="section"><a href="pm_folders.php#pm_folders_custom">5.5.3.1. Custom Folders</a></span></dt><dt><span class="section"><a href="pm_folders.php#pm_folders_moving">5.5.3.2. Moving Messages</a></span></dt><dt><span class="section"><a href="pm_folders.php#pm_folders_marking">5.5.3.3. Message Markers</a></span></dt></dl></dd><dt><span class="section"><a href="pm_filters.php">5.5.4. Message filters</a></span></dt></dl></dd><dt><span class="section"><a href="user_search.php">5.6. Search - How to Find What You are Looking For</a></span></dt><dt><span class="section"><a href="user_memberlist.php">5.7. The Memberlist - More Than Meets the Eye</a></span></dt></dl></div><div class="abstract"><p class="title"><b>Abstract</b></p><p>This chapter is targeted at the forum users. It explains all user facing functions that are needed to use phpBB 3.0</p></div></div><div class="copyright">© 2006, 2008 phpBB Group — Licensed under the Creative Commons <a href="http://creativecommons.org/licenses/by-nc-sa/3.0/">Attribution-NonCommercial-ShareAlike 3.0</a> license</div>
<?php
