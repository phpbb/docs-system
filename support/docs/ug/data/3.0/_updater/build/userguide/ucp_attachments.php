<?php
		// The page title
		$page_title = '5.3.5. Attachments';

$navigation = array(
	'home' => array('../index.php','phpBB 3.0 Olympus Documentation'),
	'this' => array('../userguide/ucp_attachments.php','Attachments'),
	'prev' => array('../',''),
	'next' => array('../',''),
...
ob_start();
?>
<div xmlns="http://www.w3.org/1999/xhtml" class="section" lang="en"><div class="titlepage"><div><div><h3 class="title"><span xmlns="" id="ucp_attachments"/>5.3.5. Attachments</h3></div></div></div><p>TODO: The attachment section of the UCP shows you a list of all attachments that you have uploaded to the board so far ... </p></div><div class="copyright">© 2006, 2008 phpBB Group — Licensed under the Creative Commons <a href="http://creativecommons.org/licenses/by-nc-sa/3.0/">Attribution-NonCommercial-ShareAlike 3.0</a> license</div>
<?php
