<?php
		// The page title
		$page_title = '1.2.4. Administrator details';

$navigation = array(
	'home' => array('../index.php','phpBB 3.0 Olympus Documentation'),
	'this' => array('../quickstart/quick_installation_admin.php','Administrator details'),
	'prev' => array('../',''),
	'next' => array('../',''),
...
ob_start();
?>
<div xmlns="http://www.w3.org/1999/xhtml" class="section" lang="en"><div class="titlepage"><div><div><h3 class="title"><span xmlns="" id="quick_installation_admin"/>1.2.4. Administrator details</h3></div></div></div><p>Now you have to create your administration user. This user will have full administration access and he will be the first user on your forum. All fields on this page are required. You can also set the default language of your forum on this page. In a vanilla (basic) phpBB 3.0 installation we only include <span class="guilabel">English [GB]</span>. You can download further languages from <a href="http://www.phpbb.com/languages/" target="_top">www.phpbb.com</a>, and add them later.</p></div><div class="copyright">© 2006, 2008 phpBB Group — Licensed under the Creative Commons <a href="http://creativecommons.org/licenses/by-nc-sa/3.0/">Attribution-NonCommercial-ShareAlike 3.0</a> license</div>
<?php
