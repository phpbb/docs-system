<?php
		// The page title
		$page_title = '1.2.1. Introduction';

$navigation = array(
	'home' => array('../index.php','phpBB 3.0 Olympus Documentation'),
	'this' => array('../quickstart/quick_installation_intro.php','Introduction'),
	'prev' => array('../',''),
	'next' => array('../',''),
...
ob_start();
?>
<div xmlns="http://www.w3.org/1999/xhtml" class="section" lang="en"><div class="titlepage"><div><div><h3 class="title"><span xmlns="" id="quick_installation_intro"/>1.2.1. Introduction</h3></div></div></div><p>The installation screen gives you a short introduction into phpBB. It allows you to read the license phpBB 3.0 is released under (the <a href="http://opensource.org/licenses/gpl-license.php" target="_top">General Public License</a>) and provides information about how you can receive support. To start the installation, click the <span class="guilabel">Install</span> tab (see <a href="quick_installation.php#img_quick_installation_intro" title="Figure 1.1. Introduction">Figure 1.1, “Introduction”</a>).</p></div><div class="copyright">© 2006, 2008 phpBB Group — Licensed under the Creative Commons <a href="http://creativecommons.org/licenses/by-nc-sa/3.0/">Attribution-NonCommercial-ShareAlike 3.0</a> license</div>
<?php
