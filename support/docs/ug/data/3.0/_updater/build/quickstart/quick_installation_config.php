<?php
		// The page title
		$page_title = '1.2.5. Configuration file';

$navigation = array(
	'home' => array('../index.php','phpBB 3.0 Olympus Documentation'),
	'this' => array('../quickstart/quick_installation_config.php','Configuration file'),
	'prev' => array('../',''),
	'next' => array('../',''),
...
ob_start();
?>
<div xmlns="http://www.w3.org/1999/xhtml" class="section" lang="en"><div class="titlepage"><div><div><h3 class="title"><span xmlns="" id="quick_installation_config"/>1.2.5. Configuration file</h3></div></div></div><p>In this step, phpBB will automatically try to write the configuration file. The forum needs the configuration to run properly. It contains all of the database settings, so without it, phpBB will not be able to access the database.</p><p>Usually, automatically writing the configuration file works fine. But in some cases it can fail due to wrong file permissions, for instance. In this case, you need to upload the file manually. phpBB asks you to <span class="guilabel">download</span> the config.php file and tells you what to do with it. Please read the instructions carefully. After you have uploaded the file, click <span class="guilabel">Done</span> to get to the last step. If <span class="guilabel">Done</span> returns you to the same page as before, and does not return a success message, you did not upload the file correctly.</p></div><div class="copyright">© 2006, 2008 phpBB Group — Licensed under the Creative Commons <a href="http://creativecommons.org/licenses/by-nc-sa/3.0/">Attribution-NonCommercial-ShareAlike 3.0</a> license</div>
<?php
