<?php
		// The page title
		$page_title = 'Chapter 1. Quick Start Guide';

$navigation = array(
	'home' => array('../index.php','phpBB 3.0 Olympus Documentation'),
	'this' => array('../quickstart/index.php','Quick Start Guide'),
	'prev' => array('../',''),
	'next' => array('../',''),
...
ob_start();
?>
<div xmlns="http://www.w3.org/1999/xhtml" class="chapter" lang="en"><div class="titlepage"><div><div><h2 class="title"><span xmlns="" id="quick_start_guide"/>Chapter 1. Quick Start Guide</h2></div><div><p class="releaseinfo">$Id: quick_start_guide.xml 369 2011-05-19 19:35:00Z Noxwizard $</p></div><div><p class="copyright">Copyright © 2006 phpBB Group</p></div></div></div><div class="toc"><p><b>Table of Contents</b></p><dl><dt><span class="section"><a href="quick_requirements.php">1.1. Requirements</a></span></dt><dt><span class="section"><a href="quick_installation.php">1.2. Installation</a></span></dt><dd><dl><dt><span class="section"><a href="quick_installation_intro.php">1.2.1. Introduction</a></span></dt><dt><span class="section"><a href="quick_installation_requirements.php">1.2.2. Requirements</a></span></dt><dt><span class="section"><a href="quick_installation_database.php">1.2.3. Database settings</a></span></dt><dt><span class="section"><a href="quick_installation_admin.php">1.2.4. Administrator details</a></span></dt><dt><span class="section"><a href="quick_installation_config.php">1.2.5. Configuration file</a></span></dt><dt><span class="section"><a href="quick_installation_advanced.php">1.2.6. Advanced settings</a></span></dt></dl></dd><dt><span class="section"><a href="quick_settings.php">1.3. General settings</a></span></dt><dd><dl><dt><span class="section"><a href="quick_settings_boardsettings.php">1.3.1. Board Settings</a></span></dt><dt><span class="section"><a href="quick_settings_boardfeatures.php">1.3.2. Board Features</a></span></dt></dl></dd><dt><span class="section"><a href="quick_forums.php">1.4. Creating and setting up forums</a></span></dt><dt><span class="section"><a href="quick_permissions.php">1.5. Setting permissions</a></span></dt><dd><dl><dt><span class="section"><a href="quick_permissions_types.php">1.5.1. Permission types</a></span></dt><dt><span class="section"><a href="quick_permissions_forum.php">1.5.2. Setting forum permissions</a></span></dt><dt><span class="section"><a href="quick_permissions_manual.php">1.5.3. Manual permissions</a></span></dt><dt><span class="section"><a href="quick_permissions_roles.php">1.5.4. Permissions roles</a></span></dt><dt><span class="section"><a href="quick_permissions_moderators.php">1.5.5. Assign moderators to forums</a></span></dt><dt><span class="section"><a href="quick_permissions_global.php">1.5.6. Setting global permissions</a></span></dt></dl></dd><dt><span class="section"><a href="quick_support.php">1.6. Obtaining support</a></span></dt></dl></div><div class="abstract"><p class="title"><b>Abstract</b></p><p>A quick guide through the first steps of installing and configuring up your very own phpBB 3.0 forum.</p></div></div><div class="copyright">© 2006, 2008 phpBB Group — Licensed under the Creative Commons <a href="http://creativecommons.org/licenses/by-nc-sa/3.0/">Attribution-NonCommercial-ShareAlike 3.0</a> license</div>
<?php
