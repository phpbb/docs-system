<?php
		// The page title
		$page_title = '1.2. Installation';

$navigation = array(
	'home' => array('../index.php','phpBB 3.0 Olympus Documentation'),
	'this' => array('../quickstart/quick_installation.php','Installation'),
	'prev' => array('../',''),
	'next' => array('../',''),
...
ob_start();
?>
<div xmlns="http://www.w3.org/1999/xhtml" class="section" lang="en"><div class="titlepage"><div><div><h2 class="title" style="clear: both"><span xmlns="" id="quick_installation"/>1.2. Installation</h2></div><div><div class="authorgroup"><div class="author"><h3 class="author"><span class="othername">dhn</span></h3></div></div></div></div></div><p>phpBB 3.0 Olympus has an easy to use installation system that will guide you through the installation process.</p><p>After you have decompressed the phpBB3 archive and uploaded the files to the location where you want it to be installed, you need to enter the <span class="acronym">URL</span> into your browser to open the installation screen. The first time you point your browser to the <span class="acronym">URL</span> (<code class="uri">http://www.example.com/phpBB3</code> for instance), phpBB will detect that it is not yet installed and automatically redirect you to the installation screen.</p><div class="figure"><span xmlns="" id="img_quick_installation_intro"/><p class="title"><b>Figure 1.1. Introduction</b></p><div class="mediaobject"><img src="../images/quick_start_guide/installation_intro.png" alt="Introduction"/><div class="caption"><p>The introduction page of the installation system.</p></div></div></div></div><div class="copyright">© 2006, 2008 phpBB Group — Licensed under the Creative Commons <a href="http://creativecommons.org/licenses/by-nc-sa/3.0/">Attribution-NonCommercial-ShareAlike 3.0</a> license</div>
<?php
