<?php
		// The page title
		$page_title = '1.3. General settings';

$navigation = array(
	'home' => array('../index.php','phpBB 3.0 Olympus Documentation'),
	'this' => array('../quickstart/quick_settings.php','General settings'),
	'prev' => array('../',''),
	'next' => array('../',''),
...
ob_start();
?>
<div xmlns="http://www.w3.org/1999/xhtml" class="section" lang="en"><div class="titlepage"><div><div><h2 class="title" style="clear: both"><span xmlns="" id="quick_settings"/>1.3. General settings</h2></div><div><div class="authorgroup"><div class="author"><h3 class="author"><span class="othername">zeroK</span></h3></div></div></div></div></div><p>In this section you will learn how to change some of the basic settings of your new board.</p><p>Right after the installation you will be redirected to the so called "Administration Control Panel" (<span class="acronym">ACP</span>). You can also access this panel by clicking the <span class="guilabel">[Administration Control Panel]</span> link at the bottom of your forum. In this interface you can change everything about your board.</p></div><div class="copyright">© 2006, 2008 phpBB Group — Licensed under the Creative Commons <a href="http://creativecommons.org/licenses/by-nc-sa/3.0/">Attribution-NonCommercial-ShareAlike 3.0</a> license</div>
<?php
